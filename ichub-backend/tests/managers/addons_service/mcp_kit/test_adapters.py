...
class TestIndustryCoreAdapterWriteMethods:
    ...
    def setup_method(self):
        ...
        with patch("managers.addons_service.mcp_kit.v1.adapters.industry_core.PartnerManagementService"), \
             patch("managers.addons_service.mcp_kit.v1.adapters.industry_core.PartManagementService"), \
             patch("managers.addons_service.mcp_kit.v1.adapters.industry_core.SharingService"), \
             patch("managers.addons_service.mcp_kit.v1.adapters.industry_core.TwinManagementService"):
            from managers.addons_service.mcp_kit.v1.adapters.industry_core import IndustryCoreAdapter
...
class TestEcopassAdapterShareDpp:
    ...
    def setup_method(self):
        with patch("managers.addons_service.mcp_kit.v1.adapters.ecopass.PassportsManager"), \
             patch("managers.addons_service.mcp_kit.v1.adapters.ecopass.ProvisionManager"):
            from managers.addons_service.mcp_kit.v1.adapters.ecopass import EcopassAdapter
