        ...
        <Box sx={{ flex: 1, minWidth: 0, mr: { xs: 0, lg: 5 } }}>
          ...
          <Box id="getting-started" sx={{ scrollMarginTop: 16 }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5, mb: 2 }}>
              {[
                'A running IC-Hub instance (v0.0.1+) with the MCP KIT addon enabled.',
            ...
            {[
              ...
              },
              {
                ...
                a: [
                  ...
                  'If your IC-Hub uses Keycloak OAuth, check that addons.mcp_kit.oauth_enabled is true in configuration.yml and that the Keycloak realm URL is accessible from the server.',
